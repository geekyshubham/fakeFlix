...
try: 
    db = MongoClient(environ["mongodb://ajghale:connectme@cluster0-shard-00-00-zrofn.mongodb.net:27017,cluster0-shard-00-01-zrofn.mongodb.net:27017,cluster0-shard-00-02-zrofn.mongodb.net:27017/mflix?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority"])["mflix"]
except KeyError:
